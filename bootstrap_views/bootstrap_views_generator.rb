...
class BootstrapViewsGenerator < Rails::Generators::Base
  ...
  def view_base_path 
    extract_modules(controller_path)[2]
  end
  ...
  def selected_views
    {
      ...
      "partials/_header.html.#{ext}"      => File.join('app/views', @controller_file_path, "partials/_header.html.#{ext}"),
      "partials/_breadcrumb.html.#{ext}"  => File.join('app/views', @controller_file_path, "partials/_breadcrumb.html.#{ext}")
    }
  end
